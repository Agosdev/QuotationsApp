...
import {  Cloud, PerspectiveCamera,  Sparkles, Stars } from "@react-three/drei";
...
const Scene3D = () => {
  ...
  return (
    <PerspectiveCamera >
        ...
        <Generic3DObject name="moon" object={<sphereGeometry />} texture={'./textures/moon.jpeg'} scale={50} position={[0,75,0]}/>
